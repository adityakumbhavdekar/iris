...
###################################################
### code chunk number 16: calibration.Snw:162-181 (eval = FALSE)
###################################################
## data = rbind(matrix(rep("A", 150), 150, 1, byrow = TRUE), 
## matrix(rep("B", 100), 100, 1, byrow = TRUE))
## data = cbind.data.frame(data, c(rep(1, 60), rep(2,50), rep(3, 60), rep(1, 40), rep(2, 40)),
...
###################################################
### code chunk number 18: calibration.Snw:265-269 (eval = FALSE)
###################################################
## X=cbind(c(rep(1,50),rep(0,50)),c(rep(0,50),rep(1,50)),1:100)
## # vector of population totals
## total=apply(X,2,"sum")
...
###################################################
### code chunk number 20: calibration.Snw:395-399 (eval = FALSE)
###################################################
## N=400
## n=100
## X=rgamma(N,3,4)
