...
setwd("E:/documents/market mix model/Final deliverable/R MMM")
...
sqrt(vif(fit)) > 2 # to identify Problematic Variables
...
mean4 <- as.data.frame(ddply(data,~Region_cd,summarise,mcampgn3=mean(campgn2)))
